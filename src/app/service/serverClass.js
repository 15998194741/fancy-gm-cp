...
var Cp_1 = __importDefault(require("../../utils/Cp"));
var serverfunc_1 = require("./serverfunc");
var serverService = (function () {
    function serverService() {
    }
    serverService.prototype.findAll = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var gameName, platform, channelNum, versionId, a, q, res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        a = gameName && platform && channelNum && versionId;
                        if (!a) {
                            throw { message: '缺少参数' };
                        }
                        return [4, redis_1.default.get("servername" + gameName + channelNum + platform + versionId)];
                    case 1:
                        q = _a.sent();
                        if (q) {
                            return [2, JSON.parse(q)];
                        }
                        return [4, serverfunc_1.findAll(gameName, platform, channelNum, versionId)];
                    case 2:
                        res = _a.sent();
                        return [2, res];
                }
    ...
    serverService.prototype.setRedis = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var gameName, platform, channelNum, versionId, a, sql, res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        gameName = data.gameName;
                        ...
                        return [4, config_1.dbSequelize.query(sql, {
                                replacements: ['active'], type: 'SELECT'
                            })];
                    case 1:
                        res = _a.sent();
                        return [4, redis_1.default.set("servername" + gameName + channelNum + platform + versionId, JSON.stringify(res))];
                    case 2: return [2, _a.sent()];
                }
            });
        });
    };
    serverService.prototype.createServer = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var id, sql, sqlRes, ip, port, url;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = data.id;
                    ...
                    case 1:
                        sqlRes = _a.sent();
                        ip = sqlRes.ip, port = sqlRes.port;
                        url = "http://" + ip + ":" + port + "/api/createServer";
                        return [4, Cp_1.default.post(url, sqlRes)];
                    case 2:
                        _a.sent();
                        return [2, true];
                }
